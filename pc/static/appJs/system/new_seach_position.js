...
window.onload = function(){
    ...
    sql += ' and (isconfidentiality=0 OR isconfidentiality IS NULL)';
    querySql = sql;
    if($('#initData').val() != ''){
...
function paginBind(dataInfo){
    ...
    $(dataInfo).each(function(i) {
        ...
        content += '        </div>';
        content += '        <div class="left" style="margin-top: 5px;width:290px;" onclick="viewPosition('+array[0]+')" >';
...
//        content += '                </p>';
        content += '                <p class="post_nowrap mbt" title="">';
        content += '                    <span class="post_price">'+array[19]+array[14]+array[23]+array[26];
        content += '                </p>';
        content += '                <p>';
        ...
        content += '            </div>';
        content += '        </div>';
        content += '<div class="left" style="margin-top: 8px;width: 400px;border-left: 1px dashed #e1e1e1;margin-bottom: 8px;padding:6px 0 6px 60px" onclick="viewPosition('+array[0]+')" >';
        ...
        content += '            </div>';
         ...
         if(array[30] != "&nbsp;" && array[30] != '') {
            // 悬赏职位
            content += '        <div class="right" onclick="loadLoginPage()" style="cursor: pointer;">';
...
//        content += '        </div>';
//        content += '        <div class="right"><input type="hidden" value="'+array[0]+'" /><input type="hidden" value="'+array[2]+'" /><input type="hidden" value="'+array[72]+'" />';
//        content += '        <a class="btn" onclick="loadLoginPage()">投递</a>';
//        content += '        <a class="btn" onclick="loadLoginPage()">收藏</a>';
//        content +=        ' <a onclick="loadLoginPage()">转发</a>';
//        content +=        ' <a onclick="loadLoginPage()">私信</a>';
//        content += '        </div>';
